const { parseProgram } = require("../src/parser/index");
const a = require("../src/parser/ast");

test('basic comment', () => {
    let r = parseProgram(`//comment with whitspace 134p43p109][];[[]//.''""'fds'\n x = 23;`)
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 2)], a.integer('23', 2))
    ]);
});
...
test('comment mid assignment', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('23', 2))
    ]);
});
...
test('comment complicated', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.for_([a.assignment([a.identifier('i', 3)], a.integer('0', 4))], a.binop('<', a.variable('i', 4), 
            a.integer('1', 5), 4), [a.static_(a.unop('++', a.variable('i', 6), 5))], [a.static_(a.integer('1', 9))])
    ]);
});
...
test('assignment', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('23', 1))
    ]);
});
...
test('re-assignment', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('1', 1)),
        a.assignment([a.identifier('x', 1)], a.binop('+', a.variable('x', 1), a.integer('1', 1), 1))
...
test('compound assignment', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([ a.assignment([a.identifier('x', 1)], a.integer('0', 1)),
        a.assignment([a.identifier('x', 1)], a.binop('+', a.variable('x', 1) , a.integer('1', 1), 1), 1)
    ]);
});
...
test('assignment chain', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1), a.identifier('y', 1), a.identifier('z', 1), a.identifier('i', 1), a.identifier('j', 1)], a.integer('5', 1))
    ]);
});
...
test('if', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1)),
        a.if_([{test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('2', 1))] }], [])
    ]);
});
...
test('if else', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1)),
        a.if_([ {test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('2', 1))] } ],
        [a.assignment([a.identifier('x', 1)], a.integer('4', 1))] )
    ]);
});
...
test('if else if, no else', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1)),
        a.if_([{test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('2', 1))] },
                {test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('4', 1))] } ], [])
    ]);
});
...
test('if else if else', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1)),
        a.if_([{test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('2', 1))] },
                {test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('8', 1))] },
                {test: a.variable('x', 1), part: [a.assignment([a.identifier('x', 1)], a.integer('4', 1))] } ],
                [a.assignment([a.identifier('x', 1)], a.integer('1', 1))])
    ]);
});
...
test('if no brackets', () => {
    ...
    expect(r.kind).toBe('ok')
    expect(r.unsafeGet()).toEqual([
        a.if_([{test: a.integer('1', 1), part: [a.static_(a.integer('1', 1))] },
                {test: a.integer('1', 1), part: [a.static_(a.integer('1', 1))] }],
                [a.static_(a.integer('1', 1))]
    )]);
})
...
test('while', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1)),
        a.while_(a.variable('x', 1), [a.assignment([a.identifier('x', 1)], a.integer('2', 1))])
    ]);
});
...
test('while no bracket', () => {
    ...
    expect(r.kind).toBe('ok')
    expect(r.unsafeGet()).toEqual([
        a.while_(a.integer('1', 1), [a.static_(a.integer('1', 1))])
    ]);
})
...
test('for simple', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.for_([a.assignment([a.identifier('x', 1)], a.integer('0', 1))], a.binop('<', a.variable('x', 1), 
            a.bool(true, 1), 1), [a.static_(a.unop('++', a.variable('x', 1), 1)), a.static_(a.integer('1', 1))], [a.assignment([a.identifier('x', 1)], a.integer('3', 1))])
    ]);
});
...
test('for complicated', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1)),
        a.for_([a.assignment([a.identifier('x', 1), a.identifier('y', 1), a.identifier('z', 1)], a.integer('15', 1)), a.assignment([a.identifier('i', 1)], a.integer('0', 1))]
        , a.binop('<', a.variable('i', 1), a.bool(true, 1), 1), [a.static_(a.unop('++', a.variable('i', 1), 1)), 
        a.assignment([a.identifier('y', 1)], a.binop('+', a.variable('y', 1), a.integer('1', 1), 1)),
        a.assignment([a.identifier('z', 1)], a.integer('0', 1))], [a.assignment([a.identifier('x', 1)], a.variable('y', 1))])
    ]);
});
...
test('for no brackets', () => {
    ...
    expect(r.kind).toBe('ok')
    expect(r.unsafeGet()).toEqual([
        a.for_([a.assignment([a.identifier('i', 1)], a.integer('0', 1))], a.binop('<', a.variable('i', 1), 
            a.integer('10', 1), 1), [a.static_(a.unop('++', a.variable('i', 1), 1))], [a.static_(a.variable('i', 1))])
    ]);
})
...
test('static', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.static_(a.binop('+', a.integer('1', 1), a.integer('2', 1), 1))
    ]);
});
...
test('null declaration', () => {
    let r = parseProgram(" a = null;");
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('a', 1)], a.null_(1))
    ]);
})
...
test('comparison', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.binop('>', a.integer('1', 1), a.integer('2', 1), 1))
    ]);
});
...
test('comparison chain', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.binop('&&', a.binop('&&', a.binop('<', a.integer('3', 1), a.integer('2', 1), 1), 
            a.binop('<', a.integer('2', 1), a.integer('3', 1), 1), 1), a.binop('<', a.integer('3', 1), a.integer('4', 1), 1), 1))
    ]);
});
...
test('Left associative mul', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.binop('+', a.integer('1', 1), a.binop('*', a.integer('2', 1), a.integer('3', 1), 1), 1))
    ]);
});
...
test('Left associative shift', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.binop('&', a.integer('1', 1), a.binop('>>', a.integer('2', 1), a.integer('1', 1), 1), 1))
    ]);
});
...
test('Left associative comparison', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.binop('&&', a.bool(true, 1), a.binop('<', a.integer('1', 1), a.integer('3', 1), 1), 1))
    ]);
});
...
test('left associative or', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.ternary(a.bool(true, 1), a.integer('1', 1), a.binop('||', a.bool(false, 1), a.bool(true, 1), 1), 1))
    ])
});
...
test('ternary declaration', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.ternary(a.bool(true, 1), a.integer('1', 1), a.integer('0', 1), 1))
    ])
});
...
test('trivial ternary nested', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.ternary(a.bool(true, 1), a.ternary(a.bool(false, 1), a.integer('1', 1), a.integer('0', 1), 1),
        a.ternary(a.bool(true, 1), a.integer('1', 1), a.integer('0', 1), 1), 1))
    ])
});
...
test('ternary precedence', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.ternary(a.binop('||', a.bool(true, 1), a.bool(false, 1), 1), a.binop('||', a.bool(false, 1), a.bool(true, 1), 1), a.integer('0', 1), 1))
    ]);
});
...
test('Built in call', () => {
    ...
    expect(r.kind).toBe('ok');
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('foo', 1)], a.call(a.variable('abs', 1), [a.integer('-1', 1)], 1))
    ])
})
...
test('ternary precedence', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.integer('10', 1))
        , a.assignment([a.identifier('x', 1)], a.ternary(a.binop('||', a.variable('x', 1), a.bool(false, 1), 1), a.binop('||', a.bool(false, 1), a.bool(true, 1), 1), a.integer('0', 1), 1))
    ]);
});
...
test('trivial collection', () => {
    let r = parseProgram('x = { a: true, b: 23 };');
    expect(r.kind).toBe('ok')
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('x', 1)], a.collection({'a': a.bool(true, 1), 'b': a.integer('23', 1)}, 1))
    ])
});
...
test('attribute accessor trivial', () => {
    ...
    expect(r.kind).toBe('ok')
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('y', 1)], a.integer('1', 1)),
...
test('collection subscriptor trivial', () => {
    ...
    expect(r.unsafeGet()).toEqual([
        a.assignment([a.identifier('y', 1)], a.integer('1', 1)),
        a.static_(a.subscriptor(a.variable('y', 1), a.integer('1', 1), 1))
    ])
});
